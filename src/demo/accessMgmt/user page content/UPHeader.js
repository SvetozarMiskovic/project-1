...
function UPHeader(props){
    return (
        <div className='up_header'>
            <Link style={{textDecoration:'none', fontSize:'1rem',justifySelf:'left',color:'#fff',textAlign:'center',  padding: '0.4rem', borderRadius:'0.4rem', backgroundColor:'#568203'}} to={'/user-view'}>Back to UserView</Link>
